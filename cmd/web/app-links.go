...
var allAppLinks = []AppLink{
	...
	{
		Title:       "Dittofeed",
		Description: "Dittofeed is for organizations that need to automatically trigger messages to their users.",
		Image:       "/static/img/dittofeed.png",
		Url:         "https://app.{BASEURI}/dashboard",
		LDAP:        false,
		SpecialNote: "Login handled with Federated Computer account.",
		Tiers: map[string]bool{
			"starter":    true,
